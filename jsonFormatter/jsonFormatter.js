    ...
    JSONFormatter = (function () {
        ...
        JSONFormatter.prototype.objectToHTML = function (object, level) {
            ...
            for (prop in object) {
                ...
                output += "<li><span class=\"q\">\"</span><span class=\"prop\">" + key + "\"</span><span class=\"q\"></span>: " + (this.valueToHTML(value, level + 1));
                if (numProps > 1) {
                    output += ',';
                }
                output += '</li>';
